...
-	quickly validate new releases of middleware or operating system updates
...
The Galasa framework works across multiple technologies in a consistent way, providing a platform to test different aspects of the application stack in the same language and in the same fashion. One test case can interact with 3270, Selenium, JMeter, batch and other applications. 
</details>
...
MTest data is often in a state of flux, resulting in the breaking of existing tests and difficulty in snapshotting and data integrity.
