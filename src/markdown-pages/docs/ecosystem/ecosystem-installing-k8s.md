...
To upgrade the Galasa Ecosystem to use a newer version of Galasa, for example version 0.26.0, run the following command:
```
helm upgrade --reuse-values --set galasaVersion=0.26.0 --wait
```
