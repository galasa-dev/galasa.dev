...
``` 
The following confirmation message is received: _Loaded image: galasadev/galasa-distribution:0.17.0_
2. Run the container by using the following command: 
```
docker run -d -p 8080:80 --name galasa galasadev/galasa-distribution:0.17.0
```
