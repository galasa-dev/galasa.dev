...
Having explored SimBank manually, it's a good time to run some or all of a small collection of automated tests that are provided with SimBank itself - go to [Running the supplied SimBank tests](/docs/getting-started/running-simbank-tests) to find out more.