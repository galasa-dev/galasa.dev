...
<details><summary>Archive request and response headers for an HTTP Client</summary>

This code enables the request and response headers to be added to the RAS for each request that is made through the HTTP Client.
