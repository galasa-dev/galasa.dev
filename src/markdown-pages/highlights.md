...
- Galasa Docker images are moving from DockerHub to the _icr.io_ domain. Images in DockerHub (release 0.19.0 and before) will be deleted when 0.21.0 is released.
